...
class MockMatplotlib:
    ...
    class colors:
        @staticmethod
        def LinearSegmentedColormap(*args, **kwargs): return None
        @staticmethod
        def Normalize(*args, **kwargs): return None
    class font_manager:
        @staticmethod
        def FontProperties(*args, **kwargs): return None
...
sys.modules['matplotlib.font_manager'] = MockMatplotlib.font_manager
...
from pymatgen.analysis.phase_diagram import plotly_layouts
        ...
        **kwargs,
        ...
        Args:
            ...
            **kwargs (dict): Keyword args passed to PDPlotter.get_plot(). Can be used to customize markers
                etc. If not set, the default is { "                                  arkerfacecolor": "#4daf4a", "markersize": 10, "linewidth": 3 }
        """
