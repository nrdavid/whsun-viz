...
}`;function G0(i,e,t){let n=new Va;const s=new oe,r=new oe,o=new it,a=new z0({depthPacking:bf}),l=new H0,c={},u=t.maxTextureSize,d={[Pn]:zt,[zt]:Pn,[Bt]:Bt},h=new Ln({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new oe},radius:{value:4}},vertexShader:k0,fragmentShader:V0}),f=h.clone();f.defines.HORIZONTAL_PASS=1;const g=new At;g.setAttribute("position",new vt(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new dt(g,h),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=ih;let p=this.type;this.render=function(R,w,I){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||R.length===0)return;const b=i.getRenderTarget(),S=i.getActiveCubeFace(),F=i.getActiveMipmapLevel(),G=i.state;G.setBlending(jn),G.buffers.color.setClear(1,1,1,1),G.buffers.depth.setTest(!0),G.setScissorTest(!1);const L=p!==Tn&&this.type===Tn,q=p===Tn&&this.type!==Tn;for(let Y=0,K=R.length;Y<K;Y++){const $=R[Y],V=$.shadow;if(V===void 0){console.warn("THREE.WebGLShadowMap:",$,"has no shadow.");continue}if(V.autoUpdate===!1&&V.needsUpdate===!1)continue;s.copy(V.mapSize);const ne=V.getFrameExtents();if(s.multiply(ne),r.copy(V.mapSize),(s.x>u||s.y>u)&&(s.x>u&&(r.x=Math.floor(u/ne.x),s.x=r.x*ne.x,V.mapSize.x=r.x),s.y>u&&(r.y=Math.floor(u/ne.y),s.y=r.y*ne.y,V.mapSize.y=r.y)),V.map===null||L===!0||q===!0){const de=this.type!==Tn?{minFilter:Ft,magFilter:Ft}:{};V.map!==null&&V.map.dispose(),V.map=new ui(s.x,s.y,de),V.map.texture.name=$.name+".shadowMap",V.camera.updateProjectionMatrix()}i.setRenderTarget(V.map),i.clear();const J=V.getViewportCount();for(let de=0;de<J;de++){const Se=V.getViewport(de);o.set(r.x*Se.x,r.y*Se.y,r.x*Se.z,r.y*Se.w),G.viewport(o),V.updateMatrices($,de),n=V.getFrustum(),y(w,I,V.camera,$,this.type)}V.isPointLightShadow!==!0&&this.type===Tn&&M(V,I),V.needsUpdate=!1}p=this.type,m.needsUpdate=!1,i.setRenderTarget(b,S,F)};function M(R,w){const I=e.update(_);h.defines.VSM_SAMPLES!==R.blurSamples&&(h.defines.VSM_SAMPLES=R.blurSamples,f.defines.VSM_SAMPLES=R.blurSamples,h.needsUpdate=!0,f.needsUpdate=!0),R.mapPass===null&&(R.mapPass=new ui(s.x,s.y)),h.uniforms.shadow_pass.value=R.map.texture,h.uniforms.resolution.value=R.mapSize,h.uniforms.radius.value=R.radius,i.setRenderTarget(R.mapPass),i.clear(),i.renderBufferDirect(w,null,I,h,_,null),f.uniforms.shadow_pass.value=R.mapPass.texture,f.uniforms.resolution.value=R.mapSize,f.uniforms.radius.value=R.radius,i.setRenderTarget(R.map),i.clear(),i.renderBufferDirect(w,null,I,f,_,null)}function v(R,w,I,b){let S=null;const F=I.isPointLight===!0?R.customDistanceMaterial:R.customDepthMaterial;if(F!==void 0)S=F;else if(S=I.isPointLight===!0?l:a,i.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0){const G=S.uuid,L=w.uuid;let q=c[G];q===void 0&&(q={},c[G]=q);let Y=q[L];Y===void 0&&(Y=S.clone(),q[L]=Y,w.addEventListener("dispose",P)),S=Y}if(S.visible=w.visible,S.wireframe=w.wireframe,b===Tn?S.side=w.shadowSide!==null?w.shadowSide:w.side:S.side=w.shadowSide!==null?w.shadowSide:d[w.side],S.alphaMap=w.alphaMap,S.alphaTest=w.alphaTest,S.map=w.map,S.clipShadows=w.clipShadows,S.clippingPlanes=w.clippingPlanes,S.clipIntersection=w.clipIntersection,S.displacementMap=w.displacementMap,S.displacementScale=w.displacementScale,S.displacementBias=w.displacementBias,S.wireframeLinewidth=w.wireframeLinewidth,S.linewidth=w.linewidth,I.isPointLight===!0&&S.isMeshDistanceMaterial===!0){const G=i.properties.get(S);G.light=I}return S}function y(R,w,I,b,S){if(R.visible===!1)return;if(R.layers.test(w.layers)&&(R.isMesh||R.isLine||R.isPoints)&&(R.castShadow||R.receiveShadow&&S===Tn)&&(!R.frustumCulled||n.intersectsObject(R))){R.modelViewMatrix.multiplyMatrices(I.matrixWorldInverse,R.matrixWorld);const L=e.update(R),q=R.material;if(Array.isArray(q)){const Y=L.groups;for(let K=0,$=Y.length;K<$;K++){const V=Y[K],ne=q[V.materialIndex];if(ne&&ne.visible){const J=v(R,ne,b,S);R.onBeforeShadow(i,R,w,I,L,J,V),i.renderBufferDirect(I,null,L,J,R,V),R.onAfterShadow(i,R,w,I,L,J,V)}}}else if(q.visible){const Y=v(R,q,b,S);R.onBeforeShadow(i,R,w,I,L,Y,null),i.renderBufferDirect(I,null,L,Y,R,null),R.onAfterShadow(i,R,w,I,L,Y,null)}}const G=R.children;for(let L=0,q=G.length;L<q;L++)y(G[L],w,I,b,S)}function P(R){R.target.removeEventListener("dispose",P);for(const I in c){const b=c[I],S=R.target.uuid;S in b&&(b[S].dispose(),delete b[S])}}}function W0(i){function e(){let x=!1;const N=new it;let z=null;const Z=new it(0,0,0,0);return{setMask:function(se){z!==se&&!x&&(i.colorMask(se,se,se,se),z=se)},setLocked:function(se){x=se},setClear:function(se,Ce,Fe,ut,St){St===!0&&(se*=ut,Ce*=ut,Fe*=ut),N.set(se,Ce,Fe,ut),Z.equals(N)===!1&&(i.clearColor(se,Ce,Fe,ut),Z.copy(N))},reset:function(){x=!1,z=null,Z.set(-1,0,0,0)}}}function t(){let x=!1,N=null,z=null,Z=null;return{setTest:function(se){se?ie(i.DEPTH_TEST):te(i.DEPTH_TEST)},setMask:function(se){N!==se&&!x&&(i.depthMask(se),N=se)},setFunc:function(se){if(z!==se){switch(se){case jd:i.depthFunc(i.NEVER);break;case Kd:i.depthFunc(i.ALWAYS);break;case $d:i.depthFunc(i.LESS);break;case jr:i.depthFunc(i.LEQUAL);break;case Zd:i.depthFunc(i.EQUAL);break;case Jd:i.depthFunc(i.GEQUAL);break;case Qd:i.depthFunc(i.GREATER);break;case ef:i.depthFunc(i.NOTEQUAL);break;default:i.depthFunc(i.LEQUAL)}z=se}},setLocked:function(se){x=se},setClear:function(se){Z!==se&&(i.clearDepth(se),Z=se)},reset:function(){x=!1,N=null,z=null,Z=null}}}function n(){let x=!1,N=null,z=null,Z=null,se=null,Ce=null,Fe=null,ut=null,St=null;return{setTest:function(je){x||(je?ie(i.STENCIL_TEST):te(i.STENCIL_TEST))},setMask:function(je){N!==je&&!x&&(i.stencilMask(je),N=je)},setFunc:function(je,ft,rt){(z!==je||Z!==ft||se!==rt)&&(i.stencilFunc(je,ft,rt),z=je,Z=ft,se=rt)},setOp:function(je,ft,rt){(Ce!==je||Fe!==ft||ut!==rt)&&(i.stencilOp(je,ft,rt),Ce=je,Fe=ft,ut=rt)},setLocked:function(je){x=je},setClear:function(je){St!==je&&(i.clearStencil(je),St=je)},reset:function(){x=!1,N=null,z=null,Z=null,se=null,Ce=null,Fe=null,ut=null,St=null}}}const s=new e,r=new t,o=new n,a=new WeakMap,l=new WeakMap;let c={},u={},d=new WeakMap,h=[],f=null,g=!1,_=null,m=null,p=null,M=null,v=null,y=null,P=null,R=new _e(0,0,0),w=0,I=!1,b=null,S=null,F=null,G=null,L=null;const q=i.getParameter(i.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let Y=!1,K=0;const $=i.getParameter(i.VERSION);$.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec($)[1]),Y=K>=1):$.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec($)[1]),Y=K>=2);let V=null,ne={};const J=i.getParameter(i.SCISSOR_BOX),de=i.getParameter(i.VIEWPORT),Se=new it().fromArray(J),Ye=new it().fromArray(de);function U(x,N,z,Z){const se=new Uint8Array(4),Ce=i.createTexture();i.bindTexture(x,Ce),i.texParameteri(x,i.TEXTURE_MIN_FILTER,i.NEAREST),i.texParameteri(x,i.TEXTURE_MAG_FILTER,i.NEAREST);for(let Fe=0;Fe<z;Fe++)x===i.TEXTURE_3D||x===i.TEXTURE_2D_ARRAY?i.texImage3D(N,0,i.RGBA,1,1,Z,0,i.RGBA,i.UNSIGNED_BYTE,se):i.texImage2D(N+Fe,0,i.RGBA,1,1,0,i.RGBA,i.UNSIGNED_BYTE,se);return Ce}const O={};O[i.TEXTURE_2D]=U(i.TEXTURE_2D,i.TEXTURE_2D,1),O[i.TEXTURE_CUBE_MAP]=U(i.TEXTURE_CUBE_MAP,i.TEXTURE_CUBE_MAP_POSITIVE_X,6),O[i.TEXTURE_2D_ARRAY]=U(i.TEXTURE_2D_ARRAY,i.TEXTURE_2D_ARRAY,1,1),O[i.TEXTURE_3D]=U(i.TEXTURE_3D,i.TEXTURE_3D,1,1),s.setClear(0,0,0,1),r.setClear(1),o.setClear(0),ie(i.DEPTH_TEST),r.setFunc(jr),ke(!1),we(yl),ie(i.CULL_FACE),et(jn);function ie(x){c[x]!==!0&&(i.enable(x),c[x]=!0)}function te(x){c[x]!==!1&&(i.disable(x),c[x]=!1)}function Pe(x,N){return u[x]!==N?(i.bindFramebuffer(x,N),u[x]=N,x===i.DRAW_FRAMEBUFFER&&(u[i.FRAMEBUFFER]=N),x===i.FRAMEBUFFER&&(u[i.DRAW_FRAMEBUFFER]=N),!0):!1}function Ue(x,N){let z=h,Z=!1;if(x){z=d.get(N),z===void 0&&(z=[],d.set(N,z));const se=x.textures;if(z.length!==se.length||z[0]!==i.COLOR_ATTACHMENT0){for(let Ce=0,Fe=se.length;Ce<Fe;Ce++)z[Ce]=i.COLOR_ATTACHMENT0+Ce;z.length=se.length,Z=!0}}else z[0]!==i.BACK&&(z[0]=i.BACK,Z=!0);Z&&i.drawBuffers(z)}function B(x){return f!==x?(i.useProgram(x),f=x,!0):!1}const Qe={[oi]:i.FUNC_ADD,[Ld]:i.FUNC_SUBTRACT,[Id]:i.FUNC_REVERSE_SUBTRACT};Qe[Nd]=i.MIN,Qe[Dd]=i.MAX;const ve={[Ud]:i.ZERO,[Od]:i.ONE,[Fd]:i.SRC_COLOR,[xa]:i.SRC_ALPHA,[Gd]:i.SRC_ALPHA_SATURATE,[kd]:i.DST_COLOR,[zd]:i.DST_ALPHA,[Bd]:i.ONE_MINUS_SRC_COLOR,[ya]:i.ONE_MINUS_SRC_ALPHA,[Vd]:i.ONE_MINUS_DST_COLOR,[Hd]:i.ONE_MINUS_DST_ALPHA,[Wd]:i.CONSTANT_COLOR,[Xd]:i.ONE_MINUS_CONSTANT_COLOR,[qd]:i.CONSTANT_ALPHA,[Yd]:i.ONE_MINUS_CONSTANT_ALPHA};function et(x,N,z,Z,se,Ce,Fe,ut,St,je){if(x===jn){g===!0&&(te(i.BLEND),g=!1);return}if(g===!1&&(ie(i.BLEND),g=!0),x!==Pd){if(x!==_||je!==I){if((m!==oi||v!==oi)&&(i.blendEquation(i.FUNC_ADD),m=oi,v=oi),je)switch(x){case ji:i.blendFuncSeparate(i.ONE,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ml:i.blendFunc(i.ONE,i.ONE);break;case Sl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case El:i.blendFuncSeparate(i.ZERO,i.SRC_COLOR,i.ZERO,i.SRC_ALPHA);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}else switch(x){case ji:i.blendFuncSeparate(i.SRC_ALPHA,i.ONE_MINUS_SRC_ALPHA,i.ONE,i.ONE_MINUS_SRC_ALPHA);break;case Ml:i.blendFunc(i.SRC_ALPHA,i.ONE);break;case Sl:i.blendFuncSeparate(i.ZERO,i.ONE_MINUS_SRC_COLOR,i.ZERO,i.ONE);break;case El:i.blendFunc(i.ZERO,i.SRC_COLOR);break;default:console.error("THREE.WebGLState: Invalid blending: ",x);break}p=null,M=null,y=null,P=null,R.set(0,0,0),w=0,_=x,I=je}return}se=se||N,Ce=Ce||z,Fe=Fe||Z,(N!==m||se!==v)&&(i.blendEquationSeparate(Qe[N],Qe[se]),m=N,v=se),(z!==p||Z!==M||Ce!==y||Fe!==P)&&(i.blendFuncSeparate(ve[z],ve[Z],ve[Ce],ve[Fe]),p=z,M=Z,y=Ce,P=Fe),(ut.equals(R)===!1||St!==w)&&(i.blendColor(ut.r,ut.g,ut.b,St),R.copy(ut),w=St),_=x,I=!1}function ye(x,N){x.side===Bt?te(i.CULL_FACE):ie(i.CULL_FACE);let z=x.side===zt;N&&(z=!z),ke(z),x.blending===ji&&x.transparent===!1?et(jn):et(x.blending,x.blendEquation,x.blendSrc,x.blendDst,x.blendEquationAlpha,x.blendSrcAlpha,x.blendDstAlpha,x.blendColor,x.blendAlpha,x.premultipliedAlpha),r.setFunc(x.depthFunc),r.setTest(x.depthTest),r.setMask(x.depthWrite),s.setMask(x.colorWrite);const Z=x.stencilWrite;o.setTest(Z),Z&&(o.setMask(x.stencilWriteMask),o.setFunc(x.stencilFunc,x.stencilRef,x.stencilFuncMask),o.setOp(x.stencilFail,x.stencilZFail,x.stencilZPass)),at(x.polygonOffset,x.polygonOffsetFactor,x.polygonOffsetUnits),x.alphaToCoverage===!0?ie(i.SAMPLE_ALPHA_TO_COVERAGE):te(i.SAMPLE_ALPHA_TO_COVERAGE)}function ke(x){b!==x&&(x?i.frontFace(i.CW):i.frontFace(i.CCW),b=x)}function we(x){x!==wd?(ie(i.CULL_FACE),x!==S&&(x===yl?i.cullFace(i.BACK):x===Rd?i.cullFace(i.FRONT):i.cullFace(i.FRONT_AND_BACK))):te(i.CULL_FACE),S=x}function We(x){x!==F&&(Y&&i.lineWidth(x),F=x)}function at(x,N,z){x?(ie(i.POLYGON_OFFSET_FILL),(G!==N||L!==z)&&(i.polygonOffset(N,z),G=N,L=z)):te(i.POLYGON_OFFSET_FILL)}function C(x){x?ie(i.SCISSOR_TEST):te(i.SCISSOR_TEST)}function E(x){x===void 0&&(x=i.TEXTURE0+q-1),V!==x&&(i.activeTexture(x),V=x)}function X(x,N,z){z===void 0&&(V===null?z=i.TEXTURE0+q-1:z=V);let Z=ne[z];Z===void 0&&(Z={type:void 0,texture:void 0},ne[z]=Z),(Z.type!==x||Z.texture!==N)&&(V!==z&&(i.activeTexture(z),V=z),i.bindTexture(x,N||O[x]),Z.type=x,Z.texture=N)}function j(){const x=ne[V];x!==void 0&&x.type!==void 0&&(i.bindTexture(x.type,null),x.type=void 0,x.texture=void 0)}function Q(){try{i.compressedTexImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ee(){try{i.compressedTexImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ge(){try{i.texSubImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function ce(){try{i.texSubImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function le(){try{i.compressedTexSubImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Ee(){try{i.compressedTexSubImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function re(){try{i.texStorage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function me(){try{i.texStorage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function Xe(){try{i.texImage2D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function xe(){try{i.texImage3D.apply(i,arguments)}catch(x){console.error("THREE.WebGLState:",x)}}function he(x){Se.equals(x)===!1&&(i.scissor(x.x,x.y,x.z,x.w),Se.copy(x))}function Re(x){Ye.equals(x)===!1&&(i.viewport(x.x,x.y,x.z,x.w),Ye.copy(x))}function Oe(x,N){let z=l.get(N);z===void 0&&(z=new WeakMap,l.set(N,z));let Z=z.get(x);Z===void 0&&(Z=i.getUniformBlockIndex(N,x.name),z.set(x,Z))}function tt(x,N){const Z=l.get(N).get(x);a.get(N)!==Z&&(i.uniformBlockBinding(N,Z,x.__bindingPointIndex),a.set(N,Z))}function Le(){i.disable(i.BLEND),i.disable(i.CULL_FACE),i.disable(i.DEPTH_TEST),i.disable(i.POLYGON_OFFSET_FILL),i.disable(i.SCISSOR_TEST),i.disable(i.STENCIL_TEST),i.disable(i.SAMPLE_ALPHA_TO_COVERAGE),i.blendEquation(i.FUNC_ADD),i.blendFunc(i.ONE,i.ZERO),i.blendFuncSeparate(i.ONE,i.ZERO,i.ONE,i.ZERO),i.blendColor(0,0,0,0),i.colorMask(!0,!0,!0,!0),i.clearColor(0,0,0,0),i.depthMask(!0),i.depthFunc(i.LESS),i.clearDepth(1),i.stencilMask(4294967295),i.stencilFunc(i.ALWAYS,0,4294967295),i.stencilOp(i.KEEP,i.KEEP,i.KEEP),i.clearStencil(0),i.cullFace(i.BACK),i.frontFace(i.CCW),i.polygonOffset(0,0),i.activeTexture(i.TEXTURE0),i.bindFramebuffer(i.FRAMEBUFFER,null),i.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),i.bindFramebuffer(i.READ_FRAMEBUFFER,null),i.useProgram(null),i.lineWidth(1),i.scissor(0,0,i.canvas.width,i.canvas.height),i.viewport(0,0,i.canvas.width,i.canvas.height),c={},V=null,ne={},u={},d=new WeakMap,h=[],f=null,g=!1,_=null,m=null,p=null,M=null,v=null,y=null,P=null,R=new _e(0,0,0),w=0,I=!1,b=null,S=null,F=null,G=null,L=null,Se.set(0,0,i.canvas.width,i.canvas.height),Ye.set(0,0,i.canvas.width,i.canvas.height),s.reset(),r.reset(),o.reset()}return{buffers:{color:s,depth:r,stencil:o},enable:ie,disable:te,bindFramebuffer:Pe,drawBuffers:Ue,useProgram:B,setBlending:et,setMaterial:ye,setFlipSided:ke,setCullFace:we,setLineWidth:We,setPolygonOffset:at,setScissorTest:C,activeTexture:E,bindTexture:X,unbindTexture:j,compressedTexImage2D:Q,compressedTexImage3D:ee,texImage2D:Xe,texImage3D:xe,updateUBOMapping:Oe,uniformBlockBinding:tt,texStorage2D:re,texStorage3D:me,texSubImage2D:ge,texSubImage3D:ce,compressedTexSubImage2D:le,compressedTexSubImage3D:Ee,scissor:he,viewport:Re,reset:Le}}function X0(i,e,t,n,s,r,o){const a=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,l=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),c=new oe,u=new WeakMap;let d;const h=new WeakMap;let f=!1;try{f=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(C,E){return f?new OffscreenCanvas(C,E):qs("canvas")}function _(C,E,X){let j=1;const Q=at(C);if((Q.width>X||Q.height>X)&&(j=X/Math.max(Q.width,Q.height)),j<1)if(typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&C instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&C instanceof ImageBitmap||typeof VideoFrame<"u"&&C instanceof VideoFrame){const ee=Math.floor(j*Q.width),ge=Math.floor(j*Q.height);d===void 0&&(d=g(ee,ge));const ce=E?g(ee,ge):d;return ce.width=ee,ce.height=ge,ce.getContext("2d").drawImage(C,0,0,ee,ge),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+ee+"x"+ge+")."),ce}else return"data"in C&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),C;return C}function m(C){return C.generateMipmaps&&C.minFilter!==Ft&&C.minFilter!==wt}function p(C){i.generateMipmap(C)}function M(C,E,X,j,Q=!1){if(C!==null){if(i[C]!==void 0)return i[C];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+C+"'")}let ee=E;if(E===i.RED&&(X===i.FLOAT&&(ee=i.R32F),X===i.HALF_FLOAT&&(ee=i.R16F),X===i.UNSIGNED_BYTE&&(ee=i.R8)),E===i.RED_INTEGER&&(X===i.UNSIGNED_BYTE&&(ee=i.R8UI),X===i.UNSIGNED_SHORT&&(ee=i.R16UI),X===i.UNSIGNED_INT&&(ee=i.R32UI),X===i.BYTE&&(ee=i.R8I),X===i.SHORT&&(ee=i.R16I),X===i.INT&&(ee=i.R32I)),E===i.RG&&(X===i.FLOAT&&(ee=i.RG32F),X===i.HALF_FLOAT&&(ee=i.RG16F),X===i.UNSIGNED_BYTE&&(ee=i.RG8)),E===i.RG_INTEGER&&(X===i.UNSIGNED_BYTE&&(ee=i.RG8UI),X===i.UNSIGNED_SHORT&&(ee=i.RG16UI),X===i.UNSIGNED_INT&&(ee=i.RG32UI),X===i.BYTE&&(ee=i.RG8I),X===i.SHORT&&(ee=i.RG16I),X===i.INT&&(ee=i.RG32I)),E===i.RGB&&X===i.UNSIGNED_INT_5_9_9_9_REV&&(ee=i.RGB9_E5),E===i.RGBA){const ge=Q?$r:$e.getTransfer(j);X===i.FLOAT&&(ee=i.RGBA32F),X===i.HALF_FLOAT&&(ee=i.RGBA16F),X===i.UNSIGNED_BYTE&&(ee=ge===ot?i.SRGB8_ALPHA8:i.RGBA8),X===i.UNSIGNED_SHORT_4_4_4_4&&(ee=i.RGBA4),X===i.UNSIGNED_SHORT_5_5_5_1&&(ee=i.RGB5_A1)}return(ee===i.R16F||ee===i.R32F||ee===i.RG16F||ee===i.RG32F||ee===i.RGBA16F||ee===i.RGBA32F)&&e.get("EXT_color_buffer_float"),ee}function v(C,E){return m(C)===!0||C.isFramebufferTexture&&C.minFilter!==Ft&&C.minFilter!==wt?Math.log2(Math.max(E.width,E.height))+1:C.mipmaps!==void 0&&C.mipmaps.length>0?C.mipmaps.length:C.isCompressedTexture&&Array.isArray(C.image)?E.mipmaps.length:1}function y(C){const E=C.target;E.removeEventListener("dispose",y),R(E),E.isVideoTexture&&u.delete(E)}function P(C){const E=C.target;E.removeEventListener("dispose",P),I(E)}function R(C){const E=n.get(C);if(E.__webglInit===void 0)return;const X=C.source,j=h.get(X);if(j){const Q=j[E.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&w(C),Object.keys(j).length===0&&h.delete(X)}n.remove(C)}function w(C){const E=n.get(C);i.deleteTexture(E.__webglTexture);const X=C.source,j=h.get(X);delete j[E.__cacheKey],o.memory.textures--}function I(C){const E=n.get(C);if(C.depthTexture&&C.depthTexture.dispose(),C.isWebGLCubeRenderTarget)for(let j=0;j<6;j++){if(Array.isArray(E.__webglFramebuffer[j]))for(let Q=0;Q<E.__webglFramebuffer[j].length;Q++)i.deleteFramebuffer(E.__webglFramebuffer[j][Q]);else i.deleteFramebuffer(E.__webglFramebuffer[j]);E.__webglDepthbuffer&&i.deleteRenderbuffer(E.__webglDepthbuffer[j])}else{if(Array.isArray(E.__webglFramebuffer))for(let j=0;j<E.__webglFramebuffer.length;j++)i.deleteFramebuffer(E.__webglFramebuffer[j]);else i.deleteFramebuffer(E.__webglFramebuffer);if(E.__webglDepthbuffer&&i.deleteRenderbuffer(E.__webglDepthbuffer),E.__webglMultisampledFramebuffer&&i.deleteFramebuffer(E.__webglMultisampledFramebuffer),E.__webglColorRenderbuffer)for(let j=0;j<E.__webglColorRenderbuffer.length;j++)E.__webglColorRenderbuffer[j]&&i.deleteRenderbuffer(E.__webglColorRenderbuffer[j]);E.__webglDepthRenderbuffer&&i.deleteRenderbuffer(E.__webglDepthRenderbuffer)}const X=C.textures;for(let j=0,Q=X.length;j<Q;j++){const ee=n.get(X[j]);ee.__webglTexture&&(i.deleteTexture(ee.__webglTexture),o.memory.textures--),n.remove(X[j])}n.remove(C)}let b=0;function S(){b=0}function F(){const C=b;return C>=s.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+C+" texture units while this GPU supports only "+s.maxTextures),b+=1,C}function G(C){const E=[];return E.push(C.wrapS),E.push(C.wrapT),E.push(C.wrapR||0),E.push(C.magFilter),E.push(C.minFilter),E.push(C.anisotropy),E.push(C.internalFormat),E.push(C.format),E.push(C.type),E.push(C.generateMipmaps),E.push(C.premultiplyAlpha),E.push(C.flipY),E.push(C.unpackAlignment),E.push(C.colorSpace),E.join()}function L(C,E){const X=n.get(C);if(C.isVideoTexture&&we(C),C.isRenderTargetTexture===!1&&C.version>0&&X.__version!==C.version){const j=C.image;if(j===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(j.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Se(X,C,E);return}}t.bindTexture(i.TEXTURE_2D,X.__webglTexture,i.TEXTURE0+E)}function q(C,E){const X=n.get(C);if(C.version>0&&X.__version!==C.version){Se(X,C,E);return}t.bindTexture(i.TEXTURE_2D_ARRAY,X.__webglTexture,i.TEXTURE0+E)}function Y(C,E){const X=n.get(C);if(C.version>0&&X.__version!==C.version){Se(X,C,E);return}t.bindTexture(i.TEXTURE_3D,X.__webglTexture,i.TEXTURE0+E)}function K(C,E){const X=n.get(C);if(C.version>0&&X.__version!==C.version){Ye(X,C,E);return}t.bindTexture(i.TEXTURE_CUBE_MAP,X.__webglTexture,i.TEXTURE0+E)}const $={[ts]:i.REPEAT,[qn]:i.CLAMP_TO_EDGE,[Kr]:i.MIRRORED_REPEAT},V={[Ft]:i.NEAREST,[rh]:i.NEAREST_MIPMAP_NEAREST,[Os]:i.NEAREST_MIPMAP_LINEAR,[wt]:i.LINEAR,[kr]:i.LINEAR_MIPMAP_NEAREST,[Rn]:i.LINEAR_MIPMAP_LINEAR},ne={[Af]:i.NEVER,[If]:i.ALWAYS,[wf]:i.LESS,[mh]:i.LEQUAL,[Rf]:i.EQUAL,[Lf]:i.GEQUAL,[Cf]:i.GREATER,[Pf]:i.NOTEQUAL};function J(C,E){if(E.type===un&&e.has("OES_texture_float_linear")===!1&&(E.magFilter===wt||E.magFilter===kr||E.magFilter===Os||E.magFilter===Rn||E.minFilter===wt||E.minFilter===kr||E.minFilter===Os||E.minFilter===Rn)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),i.texParameteri(C,i.TEXTURE_WRAP_S,$[E.wrapS]),i.texParameteri(C,i.TEXTURE_WRAP_T,$[E.wrapT]),(C===i.TEXTURE_3D||C===i.TEXTURE_2D_ARRAY)&&i.texParameteri(C,i.TEXTURE_WRAP_R,$[E.wrapR]),i.texParameteri(C,i.TEXTURE_MAG_FILTER,V[E.magFilter]),i.texParameteri(C,i.TEXTURE_MIN_FILTER,V[E.minFilter]),E.compareFunction&&(i.texParameteri(C,i.TEXTURE_COMPARE_MODE,i.COMPARE_REF_TO_TEXTURE),i.texParameteri(C,i.TEXTURE_COMPARE_FUNC,ne[E.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(E.magFilter===Ft||E.minFilter!==Os&&E.minFilter!==Rn||E.type===un&&e.has("OES_texture_float_linear")===!1)return;if(E.anisotropy>1||n.get(E).__currentAnisotropy){const X=e.get("EXT_texture_filter_anisotropic");i.texParameterf(C,X.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(E.anisotropy,s.getMaxAnisotropy())),n.get(E).__currentAnisotropy=E.anisotropy}}}function de(C,E){let X=!1;C.__webglInit===void 0&&(C.__webglInit=!0,E.addEventListener("dispose",y));const j=E.source;let Q=h.get(j);Q===void 0&&(Q={},h.set(j,Q));const ee=G(E);if(ee!==C.__cacheKey){Q[ee]===void 0&&(Q[ee]={texture:i.createTexture(),usedTimes:0},o.memory.textures++,X=!0),Q[ee].usedTimes++;const ge=Q[C.__cacheKey];ge!==void 0&&(Q[C.__cacheKey].usedTimes--,ge.usedTimes===0&&w(E)),C.__cacheKey=ee,C.__webglTexture=Q[ee].texture}return X}function Se(C,E,X){let j=i.TEXTURE_2D;(E.isDataArrayTexture||E.isCompressedArrayTexture)&&(j=i.TEXTURE_2D_ARRAY),E.isData3DTexture&&(j=i.TEXTURE_3D);const Q=de(C,E),ee=E.source;t.bindTexture(j,C.__webglTexture,i.TEXTURE0+X);const ge=n.get(ee);if(ee.version!==ge.__version||Q===!0){t.activeTexture(i.TEXTURE0+X);const ce=$e.getPrimaries($e.workingColorSpace),le=E.colorSpace===Xn?null:$e.getPrimaries(E.colorSpace),Ee=E.colorSpace===Xn||ce===le?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);let re=_(E.image,!1,s.maxTextureSize);re=We(E,re);const me=r.convert(E.format,E.colorSpace),Xe=r.convert(E.type);let xe=M(E.internalFormat,me,Xe,E.colorSpace,E.isVideoTexture);J(j,E);let he;const Re=E.mipmaps,Oe=E.isVideoTexture!==!0,tt=ge.__version===void 0||Q===!0,Le=ee.dataReady,x=v(E,re);if(E.isDepthTexture)xe=i.DEPTH_COMPONENT16,E.type===un?xe=i.DEPTH_COMPONENT32F:E.type===ns?xe=i.DEPTH_COMPONENT24:E.type===$s&&(xe=i.DEPTH24_STENCIL8),tt&&(Oe?t.texStorage2D(i.TEXTURE_2D,1,xe,re.width,re.height):t.texImage2D(i.TEXTURE_2D,0,xe,re.width,re.height,0,me,Xe,null));else if(E.isDataTexture)if(Re.length>0){Oe&&tt&&t.texStorage2D(i.TEXTURE_2D,x,xe,Re[0].width,Re[0].height);for(let N=0,z=Re.length;N<z;N++)he=Re[N],Oe?Le&&t.texSubImage2D(i.TEXTURE_2D,N,0,0,he.width,he.height,me,Xe,he.data):t.texImage2D(i.TEXTURE_2D,N,xe,he.width,he.height,0,me,Xe,he.data);E.generateMipmaps=!1}else Oe?(tt&&t.texStorage2D(i.TEXTURE_2D,x,xe,re.width,re.height),Le&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,re.width,re.height,me,Xe,re.data)):t.texImage2D(i.TEXTURE_2D,0,xe,re.width,re.height,0,me,Xe,re.data);else if(E.isCompressedTexture)if(E.isCompressedArrayTexture){Oe&&tt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,x,xe,Re[0].width,Re[0].height,re.depth);for(let N=0,z=Re.length;N<z;N++)he=Re[N],E.format!==nn?me!==null?Oe?Le&&t.compressedTexSubImage3D(i.TEXTURE_2D_ARRAY,N,0,0,0,he.width,he.height,re.depth,me,he.data,0,0):t.compressedTexImage3D(i.TEXTURE_2D_ARRAY,N,xe,he.width,he.height,re.depth,0,he.data,0,0):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?Le&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,N,0,0,0,he.width,he.height,re.depth,me,Xe,he.data):t.texImage3D(i.TEXTURE_2D_ARRAY,N,xe,he.width,he.height,re.depth,0,me,Xe,he.data)}else{Oe&&tt&&t.texStorage2D(i.TEXTURE_2D,x,xe,Re[0].width,Re[0].height);for(let N=0,z=Re.length;N<z;N++)he=Re[N],E.format!==nn?me!==null?Oe?Le&&t.compressedTexSubImage2D(i.TEXTURE_2D,N,0,0,he.width,he.height,me,he.data):t.compressedTexImage2D(i.TEXTURE_2D,N,xe,he.width,he.height,0,he.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):Oe?Le&&t.texSubImage2D(i.TEXTURE_2D,N,0,0,he.width,he.height,me,Xe,he.data):t.texImage2D(i.TEXTURE_2D,N,xe,he.width,he.height,0,me,Xe,he.data)}else if(E.isDataArrayTexture)Oe?(tt&&t.texStorage3D(i.TEXTURE_2D_ARRAY,x,xe,re.width,re.height,re.depth),Le&&t.texSubImage3D(i.TEXTURE_2D_ARRAY,0,0,0,0,re.width,re.height,re.depth,me,Xe,re.data)):t.texImage3D(i.TEXTURE_2D_ARRAY,0,xe,re.width,re.height,re.depth,0,me,Xe,re.data);else if(E.isData3DTexture)Oe?(tt&&t.texStorage3D(i.TEXTURE_3D,x,xe,re.width,re.height,re.depth),Le&&t.texSubImage3D(i.TEXTURE_3D,0,0,0,0,re.width,re.height,re.depth,me,Xe,re.data)):t.texImage3D(i.TEXTURE_3D,0,xe,re.width,re.height,re.depth,0,me,Xe,re.data);else if(E.isFramebufferTexture){if(tt)if(Oe)t.texStorage2D(i.TEXTURE_2D,x,xe,re.width,re.height);else{let N=re.width,z=re.height;for(let Z=0;Z<x;Z++)t.texImage2D(i.TEXTURE_2D,Z,xe,N,z,0,me,Xe,null),N>>=1,z>>=1}}else if(Re.length>0){if(Oe&&tt){const N=at(Re[0]);t.texStorage2D(i.TEXTURE_2D,x,xe,N.width,N.height)}for(let N=0,z=Re.length;N<z;N++)he=Re[N],Oe?Le&&t.texSubImage2D(i.TEXTURE_2D,N,0,0,me,Xe,he):t.texImage2D(i.TEXTURE_2D,N,xe,me,Xe,he);E.generateMipmaps=!1}else if(Oe){if(tt){const N=at(re);t.texStorage2D(i.TEXTURE_2D,x,xe,N.width,N.height)}Le&&t.texSubImage2D(i.TEXTURE_2D,0,0,0,me,Xe,re)}else t.texImage2D(i.TEXTURE_2D,0,xe,me,Xe,re);m(E)&&p(j),ge.__version=ee.version,E.onUpdate&&E.onUpdate(E)}C.__version=E.version}function Ye(C,E,X){if(E.image.length!==6)return;const j=de(C,E),Q=E.source;t.bindTexture(i.TEXTURE_CUBE_MAP,C.__webglTexture,i.TEXTURE0+X);const ee=n.get(Q);if(Q.version!==ee.__version||j===!0){t.activeTexture(i.TEXTURE0+X);const ge=$e.getPrimaries($e.workingColorSpace),ce=E.colorSpace===Xn?null:$e.getPrimaries(E.colorSpace),le=E.colorSpace===Xn||ge===ce?i.NONE:i.BROWSER_DEFAULT_WEBGL;i.pixelStorei(i.UNPACK_FLIP_Y_WEBGL,E.flipY),i.pixelStorei(i.UNPACK_PREMULTIPLY_ALPHA_WEBGL,E.premultiplyAlpha),i.pixelStorei(i.UNPACK_ALIGNMENT,E.unpackAlignment),i.pixelStorei(i.UNPACK_COLORSPACE_CONVERSION_WEBGL,le);const Ee=E.isCompressedTexture||E.image[0].isCompressedTexture,re=E.image[0]&&E.image[0].isDataTexture,me=[];for(let z=0;z<6;z++)!Ee&&!re?me[z]=_(E.image[z],!0,s.maxCubemapSize):me[z]=re?E.image[z].image:E.image[z],me[z]=We(E,me[z]);const Xe=me[0],xe=r.convert(E.format,E.colorSpace),he=r.convert(E.type),Re=M(E.internalFormat,xe,he,E.colorSpace),Oe=E.isVideoTexture!==!0,tt=ee.__version===void 0||j===!0,Le=Q.dataReady;let x=v(E,Xe);J(i.TEXTURE_CUBE_MAP,E);let N;if(Ee){Oe&&tt&&t.texStorage2D(i.TEXTURE_CUBE_MAP,x,Re,Xe.width,Xe.height);for(let z=0;z<6;z++){N=me[z].mipmaps;for(let Z=0;Z<N.length;Z++){const se=N[Z];E.format!==nn?xe!==null?Oe?Le&&t.compressedTexSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z,0,0,se.width,se.height,xe,se.data):t.compressedTexImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z,Re,se.width,se.height,0,se.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):Oe?Le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z,0,0,se.width,se.height,xe,he,se.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z,Re,se.width,se.height,0,xe,he,se.data)}}}else{if(N=E.mipmaps,Oe&&tt){N.length>0&&x++;const z=at(me[0]);t.texStorage2D(i.TEXTURE_CUBE_MAP,x,Re,z.width,z.height)}for(let z=0;z<6;z++)if(re){Oe?Le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,0,0,0,me[z].width,me[z].height,xe,he,me[z].data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,0,Re,me[z].width,me[z].height,0,xe,he,me[z].data);for(let Z=0;Z<N.length;Z++){const Ce=N[Z].image[z].image;Oe?Le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z+1,0,0,Ce.width,Ce.height,xe,he,Ce.data):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z+1,Re,Ce.width,Ce.height,0,xe,he,Ce.data)}}else{Oe?Le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,0,0,0,xe,he,me[z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,0,Re,xe,he,me[z]);for(let Z=0;Z<N.length;Z++){const se=N[Z];Oe?Le&&t.texSubImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z+1,0,0,xe,he,se.image[z]):t.texImage2D(i.TEXTURE_CUBE_MAP_POSITIVE_X+z,Z+1,Re,xe,he,se.image[z])}}}m(E)&&p(i.TEXTURE_CUBE_MAP),ee.__version=Q.version,E.onUpdate&&E.onUpdate(E)}C.__version=E.version}function U(C,E,X,j,Q,ee){const ge=r.convert(X.format,X.colorSpace),ce=r.convert(X.type),le=M(X.internalFormat,ge,ce,X.colorSpace);if(!n.get(E).__hasExternalTextures){const re=Math.max(1,E.width>>ee),me=Math.max(1,E.height>>ee);Q===i.TEXTURE_3D||Q===i.TEXTURE_2D_ARRAY?t.texImage3D(Q,ee,le,re,me,E.depth,0,ge,ce,null):t.texImage2D(Q,ee,le,re,me,0,ge,ce,null)}t.bindFramebuffer(i.FRAMEBUFFER,C),ke(E)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,j,Q,n.get(X).__webglTexture,0,ye(E)):(Q===i.TEXTURE_2D||Q>=i.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=i.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&i.framebufferTexture2D(i.FRAMEBUFFER,j,Q,n.get(X).__webglTexture,ee),t.bindFramebuffer(i.FRAMEBUFFER,null)}function O(C,E,X){if(i.bindRenderbuffer(i.RENDERBUFFER,C),E.depthBuffer&&!E.stencilBuffer){let j=i.DEPTH_COMPONENT24;if(X||ke(E)){const Q=E.depthTexture;Q&&Q.isDepthTexture&&(Q.type===un?j=i.DEPTH_COMPONENT32F:Q.type===ns&&(j=i.DEPTH_COMPONENT24));const ee=ye(E);ke(E)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,ee,j,E.width,E.height):i.renderbufferStorageMultisample(i.RENDERBUFFER,ee,j,E.width,E.height)}else i.renderbufferStorage(i.RENDERBUFFER,j,E.width,E.height);i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.RENDERBUFFER,C)}else if(E.depthBuffer&&E.stencilBuffer){const j=ye(E);X&&ke(E)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,j,i.DEPTH24_STENCIL8,E.width,E.height):ke(E)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,j,i.DEPTH24_STENCIL8,E.width,E.height):i.renderbufferStorage(i.RENDERBUFFER,i.DEPTH_STENCIL,E.width,E.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.RENDERBUFFER,C)}else{const j=E.textures;for(let Q=0;Q<j.length;Q++){const ee=j[Q],ge=r.convert(ee.format,ee.colorSpace),ce=r.convert(ee.type),le=M(ee.internalFormat,ge,ce,ee.colorSpace),Ee=ye(E);X&&ke(E)===!1?i.renderbufferStorageMultisample(i.RENDERBUFFER,Ee,le,E.width,E.height):ke(E)?a.renderbufferStorageMultisampleEXT(i.RENDERBUFFER,Ee,le,E.width,E.height):i.renderbufferStorage(i.RENDERBUFFER,le,E.width,E.height)}}i.bindRenderbuffer(i.RENDERBUFFER,null)}function ie(C,E){if(E&&E.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(i.FRAMEBUFFER,C),!(E.depthTexture&&E.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");(!n.get(E.depthTexture).__webglTexture||E.depthTexture.image.width!==E.width||E.depthTexture.image.height!==E.height)&&(E.depthTexture.image.width=E.width,E.depthTexture.image.height=E.height,E.depthTexture.needsUpdate=!0),L(E.depthTexture,0);const j=n.get(E.depthTexture).__webglTexture,Q=ye(E);if(E.depthTexture.format===Ki)ke(E)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0,Q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_ATTACHMENT,i.TEXTURE_2D,j,0);else if(E.depthTexture.format===Ws)ke(E)?a.framebufferTexture2DMultisampleEXT(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0,Q):i.framebufferTexture2D(i.FRAMEBUFFER,i.DEPTH_STENCIL_ATTACHMENT,i.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function te(C){const E=n.get(C),X=C.isWebGLCubeRenderTarget===!0;if(C.depthTexture&&!E.__autoAllocateDepthBuffer){if(X)throw new Error("target.depthTexture not supported in Cube render targets");ie(E.__webglFramebuffer,C)}else if(X){E.__webglDepthbuffer=[];for(let j=0;j<6;j++)t.bindFramebuffer(i.FRAMEBUFFER,E.__webglFramebuffer[j]),E.__webglDepthbuffer[j]=i.createRenderbuffer(),O(E.__webglDepthbuffer[j],C,!1)}else t.bindFramebuffer(i.FRAMEBUFFER,E.__webglFramebuffer),E.__webglDepthbuffer=i.createRenderbuffer(),O(E.__webglDepthbuffer,C,!1);t.bindFramebuffer(i.FRAMEBUFFER,null)}function Pe(C,E,X){const j=n.get(C);E!==void 0&&U(j.__webglFramebuffer,C,C.texture,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,0),X!==void 0&&te(C)}function Ue(C){const E=C.texture,X=n.get(C),j=n.get(E);C.addEventListener("dispose",P);const Q=C.textures,ee=C.isWebGLCubeRenderTarget===!0,ge=Q.length>1;if(ge||(j.__webglTexture===void 0&&(j.__webglTexture=i.createTexture()),j.__version=E.version,o.memory.textures++),ee){X.__webglFramebuffer=[];for(let ce=0;ce<6;ce++)if(E.mipmaps&&E.mipmaps.length>0){X.__webglFramebuffer[ce]=[];for(let le=0;le<E.mipmaps.length;le++)X.__webglFramebuffer[ce][le]=i.createFramebuffer()}else X.__webglFramebuffer[ce]=i.createFramebuffer()}else{if(E.mipmaps&&E.mipmaps.length>0){X.__webglFramebuffer=[];for(let ce=0;ce<E.mipmaps.length;ce++)X.__webglFramebuffer[ce]=i.createFramebuffer()}else X.__webglFramebuffer=i.createFramebuffer();if(ge)for(let ce=0,le=Q.length;ce<le;ce++){const Ee=n.get(Q[ce]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=i.createTexture(),o.memory.textures++)}if(C.samples>0&&ke(C)===!1){X.__webglMultisampledFramebuffer=i.createFramebuffer(),X.__webglColorRenderbuffer=[],t.bindFramebuffer(i.FRAMEBUFFER,X.__webglMultisampledFramebuffer);for(let ce=0;ce<Q.length;ce++){const le=Q[ce];X.__webglColorRenderbuffer[ce]=i.createRenderbuffer(),i.bindRenderbuffer(i.RENDERBUFFER,X.__webglColorRenderbuffer[ce]);const Ee=r.convert(le.format,le.colorSpace),re=r.convert(le.type),me=M(le.internalFormat,Ee,re,le.colorSpace,C.isXRRenderTarget===!0),Xe=ye(C);i.renderbufferStorageMultisample(i.RENDERBUFFER,Xe,me,C.width,C.height),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+ce,i.RENDERBUFFER,X.__webglColorRenderbuffer[ce])}i.bindRenderbuffer(i.RENDERBUFFER,null),C.depthBuffer&&(X.__webglDepthRenderbuffer=i.createRenderbuffer(),O(X.__webglDepthRenderbuffer,C,!0)),t.bindFramebuffer(i.FRAMEBUFFER,null)}}if(ee){t.bindTexture(i.TEXTURE_CUBE_MAP,j.__webglTexture),J(i.TEXTURE_CUBE_MAP,E);for(let ce=0;ce<6;ce++)if(E.mipmaps&&E.mipmaps.length>0)for(let le=0;le<E.mipmaps.length;le++)U(X.__webglFramebuffer[ce][le],C,E,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,le);else U(X.__webglFramebuffer[ce],C,E,i.COLOR_ATTACHMENT0,i.TEXTURE_CUBE_MAP_POSITIVE_X+ce,0);m(E)&&p(i.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(ge){for(let ce=0,le=Q.length;ce<le;ce++){const Ee=Q[ce],re=n.get(Ee);t.bindTexture(i.TEXTURE_2D,re.__webglTexture),J(i.TEXTURE_2D,Ee),U(X.__webglFramebuffer,C,Ee,i.COLOR_ATTACHMENT0+ce,i.TEXTURE_2D,0),m(Ee)&&p(i.TEXTURE_2D)}t.unbindTexture()}else{let ce=i.TEXTURE_2D;if((C.isWebGL3DRenderTarget||C.isWebGLArrayRenderTarget)&&(ce=C.isWebGL3DRenderTarget?i.TEXTURE_3D:i.TEXTURE_2D_ARRAY),t.bindTexture(ce,j.__webglTexture),J(ce,E),E.mipmaps&&E.mipmaps.length>0)for(let le=0;le<E.mipmaps.length;le++)U(X.__webglFramebuffer[le],C,E,i.COLOR_ATTACHMENT0,ce,le);else U(X.__webglFramebuffer,C,E,i.COLOR_ATTACHMENT0,ce,0);m(E)&&p(ce),t.unbindTexture()}C.depthBuffer&&te(C)}function B(C){const E=C.textures;for(let X=0,j=E.length;X<j;X++){const Q=E[X];if(m(Q)){const ee=C.isWebGLCubeRenderTarget?i.TEXTURE_CUBE_MAP:i.TEXTURE_2D,ge=n.get(Q).__webglTexture;t.bindTexture(ee,ge),p(ee),t.unbindTexture()}}}const Qe=[],ve=[];function et(C){if(C.samples>0){if(ke(C)===!1){const E=C.textures,X=C.width,j=C.height;let Q=i.COLOR_BUFFER_BIT;const ee=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT,ge=n.get(C),ce=E.length>1;if(ce)for(let le=0;le<E.length;le++)t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,null),t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,null,0);t.bindFramebuffer(i.READ_FRAMEBUFFER,ge.__webglMultisampledFramebuffer),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ge.__webglFramebuffer);for(let le=0;le<E.length;le++){if(C.resolveDepthBuffer&&(C.depthBuffer&&(Q|=i.DEPTH_BUFFER_BIT),C.stencilBuffer&&C.resolveStencilBuffer&&(Q|=i.STENCIL_BUFFER_BIT)),ce){i.framebufferRenderbuffer(i.READ_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.RENDERBUFFER,ge.__webglColorRenderbuffer[le]);const Ee=n.get(E[le]).__webglTexture;i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0,i.TEXTURE_2D,Ee,0)}i.blitFramebuffer(0,0,X,j,0,0,X,j,Q,i.NEAREST),l===!0&&(Qe.length=0,ve.length=0,Qe.push(i.COLOR_ATTACHMENT0+le),C.depthBuffer&&C.resolveDepthBuffer===!1&&(Qe.push(ee),ve.push(ee),i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,ve)),i.invalidateFramebuffer(i.READ_FRAMEBUFFER,Qe))}if(t.bindFramebuffer(i.READ_FRAMEBUFFER,null),t.bindFramebuffer(i.DRAW_FRAMEBUFFER,null),ce)for(let le=0;le<E.length;le++){t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglMultisampledFramebuffer),i.framebufferRenderbuffer(i.FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.RENDERBUFFER,ge.__webglColorRenderbuffer[le]);const Ee=n.get(E[le]).__webglTexture;t.bindFramebuffer(i.FRAMEBUFFER,ge.__webglFramebuffer),i.framebufferTexture2D(i.DRAW_FRAMEBUFFER,i.COLOR_ATTACHMENT0+le,i.TEXTURE_2D,Ee,0)}t.bindFramebuffer(i.DRAW_FRAMEBUFFER,ge.__webglMultisampledFramebuffer)}else if(C.depthBuffer&&C.resolveDepthBuffer===!1&&l){const E=C.stencilBuffer?i.DEPTH_STENCIL_ATTACHMENT:i.DEPTH_ATTACHMENT;i.invalidateFramebuffer(i.DRAW_FRAMEBUFFER,[E])}}}function ye(C){return Math.min(s.maxSamples,C.samples)}function ke(C){const E=n.get(C);return C.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&E.__useRenderToTexture!==!1}function we(C){const E=o.render.frame;u.get(C)!==E&&(u.set(C,E),C.update())}function We(C,E){const X=C.colorSpace,j=C.format,Q=C.type;return C.isCompressedTexture===!0||C.isVideoTexture===!0||X!==Rt&&X!==Xn&&($e.getTransfer(X)===ot?(j!==nn||Q!==$n)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",X)),E}function at(C){return typeof HTMLImageElement<"u"&&C instanceof HTMLImageElement?(c.width=C.naturalWidth||C.width,c.height=C.naturalHeight||C.height):typeof VideoFrame<"u"&&C instanceof VideoFrame?(c.width=C.displayWidth,c.height=C.displayHeight):(c.width=C.width,c.height=C.height),c}this.allocateTextureUnit=F,this.resetTextureUnits=S,this.setTexture2D=L,this.setTexture2DArray=q,this.setTexture3D=Y,this.setTextureCube=K,this.rebindTextures=Pe,this.setupRenderTarget=Ue,this.updateRenderTargetMipmap=B,this.updateMultisampleRenderTarget=et,this.setupDepthRenderbuffer=te,this.setupFrameBufferTexture=U,this.useMultisampledRTT=ke}function q0(i,e){function t(n,s=Xn){let r;const o=$e.getTransfer(s);if(n===$n)return i.UNSIGNED_BYTE;if(n===lh)return i.UNSIGNED_SHORT_4_4_4_4;if(n===ch)return i.UNSIGNED_SHORT_5_5_5_1;if(n===pf)return i.UNSIGNED_INT_5_9_9_9_REV;if(n===df)return i.BYTE;if(n===ff)return i.SHORT;if(n===oh)return i.UNSIGNED_SHORT;if(n===ah)return i.INT;if(n===ns)return i.UNSIGNED_INT;if(n===un)return i.FLOAT;if(n===ao)return i.HALF_FLOAT;if(n===mf)return i.ALPHA;if(n===gf)return i.RGB;if(n===nn)return i.RGBA;if(n===_f)return i.LUMINANCE;if(n===vf)return i.LUMINANCE_ALPHA;if(n===Ki)return i.DEPTH_COMPONENT;if(n===Ws)return i.DEPTH_STENCIL;if(n===uh)return i.RED;if(n===hh)return i.RED_INTEGER;if(n===xf)return i.RG;if(n===dh)return i.RG_INTEGER;if(n===fh)return i.RGBA_INTEGER;if(n===go||n===_o||n===vo||n===xo)if(o===ot)if(r=e.get("WEBGL_compressed_texture_s3tc_srgb"),r!==null){if(n===go)return r.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===_o)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===vo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===xo)return r.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(r=e.get("WEBGL_compressed_texture_s3tc"),r!==null){if(n===go)return r.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===_o)return r.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===vo)return r.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===xo)return r.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Tl||n===Al||n===wl||n===Rl)if(r=e.get("WEBGL_compressed_texture_pvrtc"),r!==null){if(n===Tl)return r.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Al)return r.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===wl)return r.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Rl)return r.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===Cl||n===Pl||n===Ll)if(r=e.get("WEBGL_compressed_texture_etc"),r!==null){if(n===Cl||n===Pl)return o===ot?r.COMPRESSED_SRGB8_ETC2:r.COMPRESSED_RGB8_ETC2;if(n===Ll)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:r.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===Il||n===Nl||n===Dl||n===Ul||n===Ol||n===Fl||n===Bl||n===zl||n===Hl||n===kl||n===Vl||n===Gl||n===Wl||n===Xl)if(r=e.get("WEBGL_compressed_texture_astc"),r!==null){if(n===Il)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:r.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===Nl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:r.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===Dl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:r.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===Ul)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:r.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===Ol)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:r.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===Fl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:r.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===Bl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:r.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===zl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:r.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===Hl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:r.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===kl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:r.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===Vl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:r.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===Gl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:r.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===Wl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:r.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===Xl)return o===ot?r.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:r.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===yo||n===ql||n===Yl)if(r=e.get("EXT_texture_compression_bptc"),r!==null){if(n===yo)return o===ot?r.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:r.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===ql)return r.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===Yl)return r.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===yf||n===jl||n===Kl||n===$l)if(r=e.get("EXT_texture_compression_rgtc"),r!==null){if(n===yo)return r.COMPRESSED_RED_RGTC1_EXT;if(n===jl)return r.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Kl)return r.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===$l)return r.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===$s?i.UNSIGNED_INT_24_8:i[n]!==void 0?i[n]:null}return{convert:t}}class Y0 extends Ot{constructor(e=[]){super(),this.isArrayCamera=!0,this.cameras=e}}class Nt extends nt{constructor(){super(),this.isGroup=!0,this.type="Group"}}const j0={type:"move"};class qo{constructor(){this._targetRay=null,this._grip=null,this._hand=null}getHandSpace(){return this._hand===null&&(this._hand=new Nt,this._hand.matrixAutoUpdate=!1,this._hand.visible=!1,this._hand.joints={},this._hand.inputState={pinching:!1}),this._hand}getTargetRaySpace(){return this._targetRay===null&&(this._targetRay=new Nt,this._targetRay.matrixAutoUpdate=!1,this._targetRay.visible=!1,this._targetRay.hasLinearVelocity=!1,this._targetRay.linearVelocity=new A,this._targetRay.hasAngularVelocity=!1,this._targetRay.angularVelocity=new A),this._targetRay}getGripSpace(){return this._grip===null&&(this._grip=new Nt,this._grip.matrixAutoUpdate=!1,this._grip.visible=!1,this._grip.hasLinearVelocity=!1,this._grip.linearVelocity=new A,this._grip.hasAngularVelocity=!1,this._grip.angularVelocity=new A),this._grip}dispatchEvent(e){return this._targetRay!==null&&this._targetRay.dispatchEvent(e),this._grip!==null&&this._grip.dispatchEvent(e),this._hand!==null&&this._hand.dispatchEvent(e),this}connect(e){if(e&&e.hand){const t=this._hand;if(t)for(const n of e.hand.values())this._getHandJoint(t,n)}return this.dispatchEvent({type:"connected",data:e}),this}disconnect(e){return this.dispatchEvent({type:"disconnected",data:e}),this._targetRay!==null&&(this._targetRay.visible=!1),this._grip!==null&&(this._grip.visible=!1),this._hand!==null&&(this._hand.visible=!1),this}update(e,t,n){let s=null,r=null,o=null;const a=this._targetRay,l=this._grip,c=this._hand;if(e&&t.session.visibilityState!=="visible-blurred"){if(c&&e.hand){o=!0;for(const _ of e.hand.values()){const m=t.getJointPose(_,n),p=this._getHandJoint(c,_);m!==null&&(p.matrix.fromArray(m.transform.matrix),p.matrix.decompose(p.position,p.rotation,p.scale),p.matrixWorldNeedsUpdate=!0,p.jointRadius=m.radius),p.visible=m!==null}const u=c.joints["index-finger-tip"],d=c.joints["thumb-tip"],h=u.position.distanceTo(d.position),f=.02,g=.005;c.inputState.pinching&&h>f+g?(c.inputState.pinching=!1,this.dispatchEvent({type:"pinchend",handedness:e.handedness,target:this})):!c.inputState.pinching&&h<=f-g&&(c.inputState.pinching=!0,this.dispatchEvent({type:"pinchstart",handedness:e.handedness,target:this}))}else l!==null&&e.gripSpace&&(r=t.getPose(e.gripSpace,n),r!==null&&(l.matrix.fromArray(r.transform.matrix),l.matrix.decompose(l.position,l.rotation,l.scale),l.matrixWorldNeedsUpdate=!0,r.linearVelocity?(l.hasLinearVelocity=!0,l.linearVelocity.copy(r.linearVelocity)):l.hasLinearVelocity=!1,r.angularVelocity?(l.hasAngularVelocity=!0,l.angularVelocity.copy(r.angularVelocity)):l.hasAngularVelocity=!1));a!==null&&(s=t.getPose(e.targetRaySpace,n),s===null&&r!==null&&(s=r),s!==null&&(a.matrix.fromArray(s.transform.matrix),a.matrix.decompose(a.position,a.rotation,a.scale),a.matrixWorldNeedsUpdate=!0,s.linearVelocity?(a.hasLinearVelocity=!0,a.linearVelocity.copy(s.linearVelocity)):a.hasLinearVelocity=!1,s.angularVelocity?(a.hasAngularVelocity=!0,a.angularVelocity.copy(s.angularVelocity)):a.hasAngularVelocity=!1,this.dispatchEvent(j0)))}return a!==null&&(a.visible=s!==null),l!==null&&(l.visible=r!==null),c!==null&&(c.visible=o!==null),this}_getHandJoint(e,t){if(e.joints[t.jointName]===void 0){const n=new Nt;n.matrixAutoUpdate=!1,n.visible=!1,e.joints[t.jointName]=n,e.add(n)}return e.joints[t.jointName]}}const K0=`
void main() {
...
`):s}function Dy(i,e=Xr(),t=2){const n=nd(i,e);return no([n.x,n.y,n.z],["x","y","z"],t,e.unitLabel)}function ha(i,e){const t=Ge().measurement.getPointInfo;return typeof t=="function"?t(i,e):nd(i,e)}function da(i,e,t){const n=Ge().measurement.formatPosition;return typeof n=="function"?n({position:i,info:e,settings:t,prettyText:nl,prettyTextWithUnit:no}):Dy(i,t)}function Uy(i){const e=Ge().measurement.formatDelta;if(typeof e=="function")return e({...i,prettyText:nl,prettyTextWithUnit:no});const t=i.currentPosition.clone().sub(i.startPosition);return no([t.x*i.settings.distanceScale,t.y*i.settings.distanceScale,t.z*i.settings.distanceScale,i.distance*i.settings.distanceScale],["dx","dy","dz","d"],2,i.settings.unitLabel)}function nd(i,e){const t=e.coordinateOffset||{x:0,y:0,z:0},n=e.distanceScale||1;return new A(i.x*n+t.x,i.y*n+t.y,i.z*n+t.z)}let ms=[];const ls=[],Iu=new el,Na=new Nt;Na.name="measureGroup";let id=null,il=null,Da=null;function Oy(i){Da=typeof i=="function"?i:null}function Fy(i,e,t,{onReset:n=null}={}){id=i,il=e,typeof n=="function"&&Oy(n);const s=e.parent;Na.parent||e.add(Na),ms=[];for(let r=0;r<2;r+=1)ky(r,i,s,e,t)}function By(i,e){var o;const t=Zy(),n=t.reversePan?-1:1,s=Math.min(t.minScale,t.maxScale),r=Math.max(t.minScale,t.maxScale);ms.forEach(({controller:a,grip:l})=>{const c=a.userData.gamepad,u=a.userData.handedness;!c||!u||(Jy(a),Vy({grip:l,gamepad:c,hand:u,world:e,delta:i,controlSettings:t,reverse:n,minScale:s,maxScale:r}),Gy({controller:a,gamepad:c,hand:u,world:e}))});for(const a of ls)(o=a.update)==null||o.call(a)}function qr(){var i,e;for(;ls.length>0;){const t=ls.pop();(i=t.release)==null||i.call(t),(e=t.clear)==null||e.call(t)}ms.forEach(({controller:t})=>{t.userData.activeMeasure=null,t.userData.measure=null,t.userData.activeCurve=null})}function zy(i=il){qr(),Hy(i)}function Hy(i=il){if(i){if(Da){Da({renderer:id,world:i,reason:"controller"});return}i.rotation.set(0,0,0),i.scale.set(1,1,1),i.position.set(0,0,0),i.updateMatrixWorld(!0)}}const Nu=new xt,Du=new A;function ky(i,e,t,n,s){const r=e.xr.getController(i),o=e.xr.getControllerGrip(i),a=ad();if(a.useControllerModel)o.add(new Py().createControllerModel(o));else{const g=new dt(new hi(1,8,8),new wv({color:Ge().colorToThreeHex(a.sphereColor),transparent:!0,opacity:a.sphereOpacity}));g.scale.setScalar(a.sphereRadius),r.add(g),r.userData.visualSphere=g}let l,c,u,d;r.addEventListener("connected",g=>{var m;r.userData.gamepad=g.data.gamepad,r.userData.handedness=g.data.handedness,r.userData.prevStates={},l=p=>jy(p,s),c=p=>Ky(p),r.addEventListener("selectstart",l),r.addEventListener("selectend",c);const _=(m=Ge().controllers.squeezeBindings)==null?void 0:m[r.userData.handedness];_&&(u=()=>sd(_,{controller:r,world:n,phase:"press"}),d=()=>rd(_,r),r.addEventListener("squeezestart",u),r.addEventListener("squeezeend",d))}),r.addEventListener("disconnected",()=>{var _,m,p,M,v,y,P;const g=r.userData.selected;(p=(m=(_=g==null?void 0:g.userData)==null?void 0:_.slicePlane)==null?void 0:m.endGrab)==null||p.call(m),g!=null&&g.userData&&delete g.userData.selected,l&&r.removeEventListener("selectstart",l),c&&r.removeEventListener("selectend",c),u&&r.removeEventListener("squeezestart",u),d&&r.removeEventListener("squeezeend",d),(v=(M=r.userData.activeMeasure)==null?void 0:M.release)==null||v.call(M),(P=(y=r.userData.activeCurve)==null?void 0:y.release)==null||P.call(y),r.userData.activeMeasure=null,r.userData.activeCurve=null}),t.add(r),t.add(o);const h=new At().setFromPoints([new A(0,0,0),new A(0,0,-1)]),f=new Qs(h);f.name="line",f.scale.z=a.pointerLength,r.userData.pointerLine=f.clone(),r.add(r.userData.pointerLine),ms.push({controller:r,grip:o})}function Vy({grip:i,gamepad:e,hand:t,world:n,delta:s,controlSettings:r,reverse:o,minScale:a,maxScale:l}){const c=e.axes[2],u=e.axes[3];if(!(Math.abs(c)<=r.deadzone&&Math.abs(u)<=r.deadzone)){if(t==="right"){i.getWorldQuaternion(Nu),Du.set(c,0,u).applyQuaternion(Nu),n.position.addScaledVector(Du,o*r.moveSpeed*s);return}if(t==="left"){n.rotateY(c*r.rotateSpeed*s);const d=1-u*r.zoomSpeed*s;n.scale.multiplyScalar(d),n.scale.clampScalar(a,l)}}}function Gy({controller:i,gamepad:e,hand:t,world:n}){var r;const s=((r=Ge().controllers.buttonBindings)==null?void 0:r[t])||{};for(const[o,a]of Object.entries(s)){if(!e.buttons[o])continue;const l=Yy(i,Number(o));l==="pressed"&&sd(a,{controller:i,world:n,phase:"press"}),l==="released"&&rd(a,i)}}function sd(i,e){var s;const n=od(i).press;if(n)if(n==="measure")Wy(e.controller,e.world);else if(n==="curve")Xy(e.controller,e.world);else if(n==="reset")zy(e.world);else if(n==="deleteLatest")qy();else{const r=(s=Ge().controllers.actions)==null?void 0:s[n];r==null||r(e)}}function rd(i,e){var s,r,o,a,l;const t=od(i),n=t.release||t.press;if(n==="measure")(r=(s=e.userData.activeMeasure)==null?void 0:s.release)==null||r.call(s),e.userData.activeMeasure=null,e.userData.measure=null;else if(n==="curve")(a=(o=e.userData.activeCurve)==null?void 0:o.release)==null||a.call(o),e.userData.activeCurve=null;else if(t.release){const c=(l=Ge().controllers.actions)==null?void 0:l[t.release];c==null||c({controller:e,phase:"release"})}}function Wy(i,e){const t=new Ny({world:e,controller:i});ls.push(t),i.userData.activeMeasure=t}function Xy(i,e){const t=new Iy({world:e,controller:i});ls.push(t),i.userData.activeCurve=t}function qy(){var e,t;const i=ls.pop();i&&((e=i.release)==null||e.call(i),(t=i.clear)==null||t.call(i),ms.forEach(({controller:n})=>{n.userData.activeMeasure===i&&(n.userData.activeMeasure=null,n.userData.measure=null),n.userData.activeCurve===i&&(n.userData.activeCurve=null)}))}function od(i){return typeof i=="string"?{press:i}:i||{}}function Yy(i,e){var r,o;const n=!!((r=i.userData.gamepad.buttons[e])!=null&&r.pressed),s=!!((o=i.userData.prevStates)!=null&&o[e]);return n&&!s?(i.userData.prevStates[e]=n,"pressed"):n&&s?"held":!n&&s?(i.userData.prevStates[e]=n,"released"):"none"}function jy(i,e){var s;const t=i.target,n=$y(t,e);if(n.length>0){const r=n[0].object;try{r.material.emissive.b=1}catch{}t.userData.selected=r,(s=r.userData.slicePlane)!=null&&s.beginGrab?r.userData.slicePlane.beginGrab(t):(r.userData.grabController=t,r.userData.selected=!0,r.userData.grabInitial=t.position.clone(),r.userData.planeInitial=r.position.clone())}t.userData.targetRayMode=i.data.targetRayMode}function Ky(i){var n;const e=i.target,t=e.userData.selected;if(t){try{t.material.emissive.b=0}catch{}e.userData.selected=void 0,(n=t.userData.slicePlane)!=null&&n.endGrab?t.userData.slicePlane.endGrab():t.userData.selected=!1}}function $y(i,e){return i.updateMatrixWorld(),Iu.setFromXRController(i),Iu.intersectObjects(e.children,!1)}function Zy(){var t,n,s;const i=Ge(),e=((n=(t=i.settings).get)==null?void 0:n.call(t))||{};return pi(i.controllers.controls,((s=e.user)==null?void 0:s.controls)||{})}function ad(){var t,n,s;const i=Ge(),e=((n=(t=i.settings).get)==null?void 0:n.call(t))||{};return pi(i.controllers.visuals,((s=e.debug)==null?void 0:s.controllers)||{})}function Jy(i){const e=ad(),t=i.userData.visualSphere,n=i.userData.pointerLine;t&&(t.scale.setScalar(e.sphereRadius),t.material.color.setHex(Ge().colorToThreeHex(e.sphereColor)),t.material.opacity=e.sphereOpacity),n&&(n.scale.z=e.pointerLength)}const Qy="gui-vr-source-styles",Uu=1,eM=12;let He=null,ze=null,st=null,qe=null,dn=null,Gi=null,Wi=null,Xi=null,qi=null,li=0,ci=0,Ji=0;const Yi=new Set;let js=0,Gt=null,sl=0,rl=0,ol=0,al=0,Kt=!1,io=!1,hn=!1,ll=Ge().guiMesh.position.clone(),tM=new A(.85,1.35,-1.2),cl=Ge().guiMesh.rotation.clone(),nM=new ct(0,-Math.PI/6,0),ho=Ge().guiMesh.scale,Ua=1.35,Ks="hud--vr-menu-source";new A;new A;new A(0,1,0);new A;function iM(i,e,{renderer:t=null,camera:n=null,visible:s=!1,position:r=Ge().guiMesh.position,rotation:o=Ge().guiMesh.rotation,scale:a=Ge().guiMesh.scale,sourceClass:l="hud--vr-menu-source"}={}){return ld(),fM(l),st=md(e),ll=r.clone(),cl=o.clone(),ho=a,Ks=l,hn=!!s,st.classList.toggle(Ks,hn),He=new Jh,He.name="guiGroup",He.visible=hn,t&&n&&He.listenToPointerEvents(t,n),ms.forEach(({controller:c})=>{He.listenToXRControllerEvents(c)}),i.add(He),hl(),oM(),lM(),uM(),{guiGroup:He,htmlMesh:ze}}function sM(i,e,{visible:t=!1,scale:n=Ua}={}){return dn=md(e),Ua=n,hn=!!t,He||(He=new Jh,He.name="guiGroup",i.add(He)),He.visible=hn,ud(),aM(),cM(),{guiGroup:He,legendMesh:qe}}function Ou(i){hn=!!i,st&&(st.classList.toggle(Ks,hn),Kt=!0),dn&&(io=!0),He&&(He.visible=hn),hn&&(gs(),dl())}function ul({position:i,rotation:e,scale:t,force:n=!1,fit:s=!0}={}){return He?(i&&(ll.copy(i),Kt=!0),e&&(cl.copy(e),Kt=!0),Number.isFinite(t)&&(ho=t,Kt=!0),n?(hl(pl(),{fit:s}),Kt=!1):rM(),cd(),{guiGroup:He,htmlMesh:ze,legendMesh:qe}):null}function ld(){var i,e,t,n,s,r;Gi==null||Gi.disconnect(),Wi==null||Wi.disconnect(),Xi==null||Xi.disconnect(),qi==null||qi.disconnect(),Gi=null,Wi=null,Xi=null,qi=null,li&&cancelAnimationFrame(li),ci&&cancelAnimationFrame(ci),Ji&&clearTimeout(Ji);for(const o of Yi)clearTimeout(o);Yi.clear(),li=0,ci=0,Ji=0,st&&Gt&&(st.removeEventListener("input",Gt,!0),st.removeEventListener("change",Gt,!0),st.removeEventListener("click",Gt,!0),st.removeEventListener("mousedown",Gt,!0),st.removeEventListener("mouseup",Gt,!0),Gt=null),(i=ze==null?void 0:ze.dispose)==null||i.call(ze),(e=ze==null?void 0:ze.removeFromParent)==null||e.call(ze),(t=qe==null?void 0:qe.dispose)==null||t.call(qe),(n=qe==null?void 0:qe.removeFromParent)==null||n.call(qe),(s=He==null?void 0:He.disconnect)==null||s.call(He),(r=He==null?void 0:He.removeFromParent)==null||r.call(He),st==null||st.classList.remove(Ks),ze=null,qe=null,He=null,st=null,dn=null,sl=0,rl=0,ol=0,al=0,hn=!1,Kt=!1,io=!1,js=0}function rM(){if(!st)return;const i=pl();Kt||!ze||i.width!==sl||i.height!==rl?hl(i):hd(ze),Kt=!1}function cd(){if(!dn)return;const i=dd();io||!qe||i.width!==ol||i.height!==al?ud(i):hd(qe),io=!1}function hl(i=pl(),{fit:e=!0}={}){var s,r;if(!He||!st)return;if(i.width<Uu||i.height<Uu){hM();return}js=0;const t=He.visible;(s=ze==null?void 0:ze.dispose)==null||s.call(ze),(r=ze==null?void 0:ze.removeFromParent)==null||r.call(ze),ze=new Zh(st),ze.name="guiMesh",ze.position.copy(ll),ze.rotation.copy(cl),ze.scale.setScalar(e?pd(i.height):ho),ze.material.side=Bt,ze.material.depthWrite=!1,ze.renderOrder=20;const n=()=>gs();ze.addEventListener("mousedown",n),ze.addEventListener("mousemove",n),ze.addEventListener("mouseup",n),ze.addEventListener("click",n),He.add(ze),He.visible=t,sl=i.width,rl=i.height}function ud(i=dd()){var t,n;if(!He||!dn)return;const e=He.visible;(t=qe==null?void 0:qe.dispose)==null||t.call(qe),(n=qe==null?void 0:qe.removeFromParent)==null||n.call(qe),qe=new Zh(dn),qe.name="legendMesh",qe.position.copy(tM),qe.rotation.copy(nM),qe.scale.setScalar(pd(i.height,Ua,.86)),qe.material.side=Bt,qe.material.depthWrite=!1,qe.renderOrder=19,He.add(qe),He.visible=e,ol=i.width,al=i.height}function oM(){typeof ResizeObserver>"u"||(Gi=new ResizeObserver(()=>{js=0,Kt=!0,gs(),fl()}),Gi.observe(st))}function aM(){typeof ResizeObserver>"u"||(Xi=new ResizeObserver(()=>dl()),Xi.observe(dn))}function lM(){typeof MutationObserver>"u"||(Wi=new MutationObserver(()=>{Kt=!0,gs(),fl()}),Wi.observe(st,{attributes:!0,childList:!0,subtree:!0,characterData:!0,attributeFilter:["hidden","aria-pressed","disabled","value","style","class"]}))}function cM(){typeof MutationObserver>"u"||(qi=new MutationObserver(()=>dl()),qi.observe(dn,{attributes:!0,childList:!0,subtree:!0,characterData:!0,attributeFilter:["hidden","style","class"]}))}function uM(){Gt=()=>{Kt=!0,gs(),fl()},st.addEventListener("input",Gt,!0),st.addEventListener("change",Gt,!0),st.addEventListener("click",Gt,!0),st.addEventListener("mousedown",Gt,!0),st.addEventListener("mouseup",Gt,!0)}function gs(){!He||!st||(li&&cancelAnimationFrame(li),li=requestAnimationFrame(()=>{li=0,ul()}))}function dl(){!He||!dn||(ci&&cancelAnimationFrame(ci),ci=requestAnimationFrame(()=>{ci=0,cd()}))}function hM(){Ji||js>=eM||(js+=1,Ji=setTimeout(()=>{Ji=0,ul()},50))}function fl(){for(const i of Yi)clearTimeout(i);Yi.clear();for(const i of[50,150,300]){const e=setTimeout(()=>{Yi.delete(e),Kt=!0,gs()},i);Yi.add(e)}}function hd(i){var t;const e=(t=i==null?void 0:i.material)==null?void 0:t.map;typeof(e==null?void 0:e.update)=="function"?e.update():e&&(e.needsUpdate=!0)}function pl(){return fd(st)}function dd(){return fd(dn)}function fd(i){const e=dM(i);if(e)return e;const t=i.getBoundingClientRect();return{width:Math.round(Math.max(t.width||0,i.offsetWidth||0,i.scrollWidth||0)),height:Math.round(Math.max(t.height||0,i.offsetHeight||0,i.scrollHeight||0))}}function dM(i){var l,c,u;if(!((l=i==null?void 0:i.classList)!=null&&l.contains("lil-gui")))return null;const e=i.getBoundingClientRect(),t=Fu(i,"title"),n=Fu(i,"children"),s=(c=t==null?void 0:t.getBoundingClientRect)==null?void 0:c.call(t),r=(u=n==null?void 0:n.getBoundingClientRect)==null?void 0:u.call(n),o=Math.max(e.width||0,i.offsetWidth||0,i.scrollWidth||0,(n==null?void 0:n.scrollWidth)||0,(r==null?void 0:r.width)||0),a=Math.max(e.height||0,i.offsetHeight||0,i.scrollHeight||0,((s==null?void 0:s.height)||(t==null?void 0:t.offsetHeight)||0)+((n==null?void 0:n.scrollHeight)||(r==null?void 0:r.height)||0));return{width:Math.round(o),height:Math.round(a)}}function Fu(i,e){return Array.from(i.children||[]).find(t=>{var n;return(n=t.classList)==null?void 0:n.contains(e)})}function pd(i,e=ho,t=Ge().guiMesh.maxMenuHeightMeters){const n=Math.max(i*.001,.001);return Math.min(e,t/n)}function fM(i=Ks){if(typeof document>"u")return;const e=`${Qy}-${i}`,t=`
  ...
  `,n=document.getElementById(e);if(n){n.textContent=t;return}const s=document.createElement("style");s.id=e,s.textContent=t,document.head.appendChild(s)}function md(i){const e=(i==null?void 0:i.domElement)||i;if(!(e instanceof HTMLElement))throw new TypeError("VR GUI input must be an HTMLElement or an object with domElement");return e}new A(0,0,1);new qh;function pM({menuContainer:i,modes:e,offMode:t="none",getState:n,setState:s}){if(!i||typeof document>"u")return null;mM(),i.classList.add("slice-plane-menu-host");const r=[...e.map(m=>({mode:m.mode,label:m.label||m.mode})),{mode:t,label:"Off"}],o=document.createElement("section");o.className="slice-plane-menu";const a=document.createElement("div");a.className="slice-plane-menu__header";const l=document.createElement("span");l.textContent="Slice Plane";const c=document.createElement("span");c.className="slice-plane-menu__value",a.append(l,c);const u=document.createElement("div");u.className="slice-plane-menu__segments",u.style.gridTemplateColumns=`repeat(${r.length}, minmax(0, 1fr))`;const d=new Map;for(const m of r){const p=document.createElement("button");p.type="button",p.className="slice-plane-menu__button",p.textContent=m.label,p.addEventListener("click",()=>{s({mode:m.mode,reverse:f.checked})}),d.set(m.mode,p),u.appendChild(p)}const h=document.createElement("label");h.className="slice-plane-menu__reverse";const f=document.createElement("input");f.type="checkbox",f.addEventListener("change",()=>{const m=n();s({...m,mode:m.mode||t,reverse:f.checked})});const g=document.createElement("span");g.textContent="Reverse",h.append(f,g),o.append(a,u,h),i.replaceChildren(o);function _(m=n()){const p=m.mode||t,M=r.find(v=>v.mode===p)||r[r.length-1];c.textContent=M.label,f.checked=!!m.reverse;for(const[v,y]of d)y.classList.toggle("is-active",v===M.mode)}return _(),{update:_,destroy(){o.remove()}}}function mM(){if(document.getElementById("slice-plane-menu-styles"))return;const i=document.createElement("style");i.id="slice-plane-menu-styles",i.textContent=`
  ...
  `,i.appendChild(t),i.appendChild(n),i.appendChild(r),i.appendChild(s);const o=t.querySelector("[data-status]"),a=r.querySelector("[data-total]"),l=r.querySelector("[data-rendered]"),c=r.querySelector("[data-scale]"),u=t.querySelector("[data-range]"),d=t.querySelector("[data-sample-options]"),h=t.querySelector("[data-point-size-options]"),f=t.querySelector("[data-reset]"),g=t.querySelector("[data-slice-label]"),_=n.querySelector("[data-slice-detail-label]"),m=t.querySelector("[data-slice-xz]"),p=t.querySelector("[data-slice-free]"),M=t.querySelector("[data-slice-clear]"),v=n.querySelector("[data-slice-fixed]"),y=n.querySelector("[data-slice-free-controls]"),P=n.querySelector("[data-slice-position]"),R=t.querySelector("[data-slice-reverse]"),w={x:n.querySelector("[data-slice-free-x]"),y:n.querySelector("[data-slice-free-y]"),z:n.querySelector("[data-slice-free-z]"),rx:n.querySelector("[data-slice-free-rx]"),ry:n.querySelector("[data-slice-free-ry]"),rz:n.querySelector("[data-slice-free-rz]")};let I=nh(),b=eh,S=()=>{},F=()=>{},G="none",L=()=>{};for(const O of e){const ie=document.createElement("option");ie.value=O.url,ie.textContent=O.label,u.appendChild(ie)}u.addEventListener("change",()=>{S(q())}),th(d,Sd,I,O=>{I=O,Hr(d,O),S(q())}),th(h,BM,b,O=>{b=O,Hr(h,O),F(b)}),m.addEventListener("click",()=>{$("xz")}),p.addEventListener("click",()=>{$("free")}),M.addEventListener("click",()=>{$("none")}),P.addEventListener("input",J),R.addEventListener("change",J),Object.values(w).forEach(O=>{O.addEventListener("input",J)}),window.addEventListener("resize",K),window.ResizeObserver&&new ResizeObserver(K).observe(t);function q(){var O;return{rangeUrl:u.value,rangeLabel:((O=u.selectedOptions[0])==null?void 0:O.textContent)||"",sampleCount:I,pointSize:b}}function Y(O){u.disabled=O,HM(d,O)}function K(){const O=t.getBoundingClientRect();n.style.left=`${Math.round(O.left)}px`,n.style.top=`${Math.round(O.bottom+10)}px`,n.style.width=`${Math.round(O.width)}px`}function $(O){G!==O&&(O==="xz"?P.value="0":O==="free"&&Object.values(w).forEach(ie=>{ie.value="0"}),R.checked=!1),G=O,V(),J()}function V(){const O=G==="xz"?"X-Z":G==="free"?"Free":"Off";g.textContent=O,_.textContent=O,R.disabled=G==="none",n.hidden=G==="none",v.hidden=G!=="xz",y.hidden=G!=="free",m.setAttribute("aria-pressed",String(G==="xz")),p.setAttribute("aria-pressed",String(G==="free")),M.setAttribute("aria-pressed",String(G==="none"))}function ne(){return G==="none"?{mode:"none"}:G==="xz"?{mode:"xz",position:Number.parseFloat(P.value),reverse:R.checked}:{mode:"free",position:{x:Number.parseFloat(w.x.value),y:Number.parseFloat(w.y.value),z:Number.parseFloat(w.z.value)},rotation:{x:Number.parseFloat(w.rx.value),y:Number.parseFloat(w.ry.value),z:Number.parseFloat(w.rz.value)},reverse:R.checked}}function J(){L(ne())}function de(O){o.textContent=O}function Se({totalRecords:O=0,renderedRecords:ie=0,nmPerWorldUnit:te=0}={}){a.textContent=Us(O),l.textContent=Us(ie),c.textContent=te?te.toFixed(2):"--"}function Ye(O){const ie=O.totalChunks?Math.round(O.loadedChunks/O.totalChunks*100):0;de(`${ie}% sampled`),l.textContent=Us(O.loadedRecords),a.textContent=Us(O.totalRecords)}function U(O){s.innerHTML="";for(const ie of O){const te=document.createElement("div");te.className="legend__item",te.innerHTML=`
        <span class="legend__swatch"></span>
        <span class="legend__name"></span>
        <span class="legend__count"></span>
      `,te.querySelector(".legend__swatch").style.setProperty("--swatch",ie.color),te.querySelector(".legend__name").textContent=ie.label,te.querySelector(".legend__count").textContent=Us(ie.count),s.appendChild(te)}}return V(),K(),{getState:q,getMenuElement(){return t},getLegendElement(){return s},resetControls(){return I=nh(),b=eh,Hr(d,I),Hr(h,b),$("none"),q()},setLoading:Y,setStatus:de,setStats:Se,setProgress:Ye,setLegend:U,onDataChange(O){S=typeof O=="function"?O:()=>{}},onReset(O){f.addEventListener("click",O)},onPointSize(O){F=typeof O=="function"?O:()=>{}},onSlicePlane(O){L=typeof O=="function"?O:()=>{}}}}function th(i,e,t,n){e.forEach(s=>{const r=document.createElement("button");r.className="segmented__button",r.type="button",r.textContent=s.label,r.dataset.value=String(s.value),r.setAttribute("aria-pressed",String(s.value===t)),r.addEventListener("click",()=>n(s.value)),i.appendChild(r)})}function Hr(i,e){i.querySelectorAll(".segmented__button").forEach(t=>{t.setAttribute("aria-pressed",String(Number(t.dataset.value)===e))})}function HM(i,e){i.querySelectorAll(".segmented__button").forEach(t=>{t.disabled=e})}function nh(){return Sd.some(i=>i.value===_u)?_u:1e5}function Us(i){return new Intl.NumberFormat("en-US",{notation:i>=1e6?"compact":"standard",maximumFractionDigits:1}).format(i)}async function kM(i){const e=DM(i),t=zM(i,cx);let n=null,s=0,r=null;e.setVRMenuElement(t.getMenuElement()),e.setVRLegendElement(t.getLegendElement()),e.setResetHandler(()=>{o()}),t.onReset(()=>{o()}),t.onPointSize(l=>{mu(n,l),e.refreshVRMenu()}),t.onSlicePlane(l=>{e.setSlicePlaneState(l),e.refreshVRMenu()}),t.onDataChange(l=>{a(l,{clearMeasurements:!1,resetAfterSet:!1})}),await a(t.getState());async function o(){const l=t.resetControls();mu(n,l.pointSize),e.resetExperience(),e.refreshVRMenu(),VM(l,r)||await a(l,{clearMeasurements:!1,resetAfterSet:!1})}async function a(l,{clearMeasurements:c=!0,resetAfterSet:u=!0}={}){const d=++s;t.setLoading(!0),t.setStatus("Loading ranges");try{const h=await fx(l.rangeUrl);if(d!==s)return;t.setStatus("Loading POS");const f=await Mx({url:lx,rangeTable:h,maxRecords:l.sampleCount,onProgress:g=>{d===s&&t.setProgress(g)}});if(d!==s)return;hx({distanceScale:f.transform.nmPerWorldUnit,coordinateOffset:f.transform.center,unitLabel:"nm"}),n=ax({positions:f.positions,colors:f.colors,pointSize:l.pointSize}),e.setAtomCloud(n,f,{clearMeasurements:c,resetAfterSet:u}),r={rangeUrl:l.rangeUrl,sampleCount:l.sampleCount},t.setStats({totalRecords:f.metadata.totalRecords,renderedRecords:f.count,nmPerWorldUnit:f.transform.nmPerWorldUnit}),t.setLegend(f.species),t.setStatus(GM(h,f.count))}catch(h){console.error(h),t.setStatus(h instanceof Error?h.message:"Load failed")}finally{d===s&&t.setLoading(!1)}}}function VM(i,e){return(e==null?void 0:e.rangeUrl)===i.rangeUrl&&(e==null?void 0:e.sampleCount)===i.sampleCount}function GM(i,e){const t=`${new Intl.NumberFormat("en-US").format(e)} atoms`;return i.warnings.length===0?t:`${t}, range counts differ`}const WM=document.getElementById("app");kM(WM);
